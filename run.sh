...
git clone --depth=1 https://github.com/mmoreta/flectra-17-docker-compose $DESTINATION
...
echo "Flectra started at http://localhost:$PORT | Master Password: mmoreta@info | Live chat port: $CHAT"